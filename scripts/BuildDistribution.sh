...
cd CocosBuilder/
xcodebuild -workspace CocosBuilder.xcworkspace -scheme CocosBuilder clean
xcodebuild -workspace CocosBuilder.xcworkspace -scheme CocosBuilder -configuration Release build
